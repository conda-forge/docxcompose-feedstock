...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/docxcompose-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14031&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/docxcompose-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `docxcompose` can be installed with:

```
conda install docxcompose
```

It is possible to list all of the versions of `docxcompose` available on your platform with:
